...
const CardMetrics = ({ children, title, color = MetricsColors.default }: CardMetricsProps) => {
  ...
  return (
    <div className={`p-6 flex flex-col ${injectedClasses}`}>
      <p className="text-sm font-light opacity-50 text-slate-800 dark:text-slate-200">{title}</p>
